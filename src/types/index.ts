...
export type OptionsBuilderSchema = Record<string, { __outputType: any }>

export type GetComponentPropertiesSchema<T extends OptionsBuilderSchema> = PartialIfUndefined<{
